...
def build_default_panels() -> list[BasePanel]:
    ...
    big_panel = BigPanel(x=0, y=BOTTOM_HEIGHT, width=SCREEN_WIDTH, height=SCREEN_HEIGHT - BOTTOM_HEIGHT, combat_mode=DragonState.FIRE)
    ...
    x_cursor += w1
    panels.append(SmallPanel2(x=x_cursor, y=0, width=w2, height=BOTTOM_HEIGHT, big_panel_ref=big_panel))
    x_cursor += w2
